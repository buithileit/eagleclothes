...
ImagePreload.prototype.OnComplete = function() {
	this.m_nProcessed++;
	this.m_nProcessed == this.m_nICount ? this.m_pfnFinished()
			: this.m_pfnPercent(Math
					.round(10 * (this.m_nProcessed / this.m_nICount)))
};
...
function disableSelection(b) {
	"undefined" != typeof b.style.MozUserSelect ? b.style.MozUserSelect = "none"
