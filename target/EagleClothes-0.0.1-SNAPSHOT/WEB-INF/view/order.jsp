			...
			<ul>
				<c:choose>
					...
					<c:otherwise>
						...
						<li><a href="registry.html">${appProperties["title.registry"] }</a></li>
					</c:otherwise>
				</c:choose>
				<li><i class="cart"></i><a href="loadCheckout">Cart
						(${sessionScope.shopCart.size})</a></li>
			</ul>
		</div>
	</div>
	<div class="header">
	...
	<div class="container">
		<div class="My-wish-section">
			<section id="wish">
				...
				<c:choose>
				<c:when test="${sessionScope.shopCart !=null && sessionScope.shopCart.size > 0 }"  >
					<div class="table-responsive" align="center">
						<table class="table-heading ">
							...
							<c:forEach items="${sessionScope.shopCart.orderBeans}"
								...
								<tr class="cart-header">
									...
									<td><form id="updateProductToCart" action="updateProductToCart?productId=${orderBean.productId}&color=${orderBean.color}&size=${orderBean.size}">
									<input name="productId" type="hidden"
												...
												value="${orderBean.size}">
									<div class="amount"><input type="number" id="updateCart"
										name="amount"		onchange="updateCart()" value="${orderBean.amount }" min="1">
										</div><div class="submit"><input type="submit" value="Update" name="Update"></div>
						...
						function updateCart(){
// 							alert("change");
// 							var url_update = "updateProductToCart?color=" +$("#color").val() +"productId="+$("#product_id").val() +"size="+$("#size").val()+"amount="+$("#updateCart").val()  
