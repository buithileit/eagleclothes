...
public final class main_005flogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</a></li>\r\n");
      out.write("\t\t\t\t<li><i class=\"user\"></i><a href=\"registry.html\">");
      ...
      out.write("</a></li>\r\n");
      out.write("\t\t\t\t<li><i class=\"cart\"></i><a href=\"checkout.html\">Cart\r\n");
      out.write("\t\t\t\t\t\t(");
      ...
      out.write("\t\t\t\t\t\t<li><a href=\"404.html\" data-hover=\"CLOTHER\">CLOTHER</a></li>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"products.html\" data-hover=\"PANTS\">PANTS</a></li>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"404.html\" data-hover=\"DRESS\">DRESS</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tonclick=\"location.href='shop?productId=1&color=BLUE&amount=1&size=35';\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"shop?productId=1&color=BLUE&amount=1&size=35\">Add\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tto Cart</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"product-pic-info-cart\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"p-btn\" href=\"/shop{1}\">Add to Cart</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div onclick=\"location.href='/shop{1}';\" class=\"product-grid\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"product-pic\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"images/p3.jpg\" title=\"Woman's T - Shirt\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"product-pic-info\">\r\n");
