...
public final class charts_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<li class=\"active\"><a href=\"charts.html\"><i\n");
      ...
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"active\"><i class=\"fa fa-bar-chart-o\"></i> Charts\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ol>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12\">\n");
      out.write("\t\t\t\t\t\t<h2 class=\"page-header\">Flot Charts</h2>\n");
      out.write("\t\t\t\t\t\t<p class=\"lead\">\n");
      out.write("\t\t\t\t\t\t\tFlot is a pure JavaScript plotting library for jQuery, with a\n");
      out.write("\t\t\t\t\t\t\tfocus on simple usage, attractive looks and interactive features.\n");
      out.write("\t\t\t\t\t\t\tFor full usage instructions and documentation for Flot Charts,\n");
      out.write("\t\t\t\t\t\t\tvisit <a href=\"http://www.flotcharts.org/\">http://www.flotcharts.org/</a>.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- /.row -->\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-bar-chart-o\"></i> Line Graph Example with\n");
      out.write("\t\t\t\t\t\t\t\t\tTooltips\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-long-arrow-right\"></i> Pie Chart Example with\n");
      out.write("\t\t\t\t\t\t\t\t\tTooltips\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-long-arrow-right\"></i> Multiple Axes Line Graph\n");
      out.write("\t\t\t\t\t\t\t\t\tExample with Tooltips and Raw Data\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"flot-chart\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"flot-chart-content\" id=\"flot-multiple-axes-chart\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"text-right\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\">View Details <i\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-arrow-circle-right\"></i></a>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-long-arrow-right\"></i> Moving Line Chart\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"flot-chart\">\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-long-arrow-right\"></i> Bar Graph with Tooltips\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"flot-chart\">\n");
      ...
      out.write("\t\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12\">\n");
      out.write("\t\t\t\t\t\t<h2 class=\"page-header\">Morris Charts</h2>\n");
      out.write("\t\t\t\t\t\t<p class=\"lead\">\n");
      out.write("\t\t\t\t\t\t\tMorris.js is a very simple API for drawing line, bar, area and\n");
      out.write("\t\t\t\t\t\t\tdonut charts. For full usage instructions and documentation for\n");
      out.write("\t\t\t\t\t\t\tMorris.js charts, visit <a\n");
      out.write("\t\t\t\t\t\t\t\thref=\"http://morrisjs.github.io/morris.js/\">http://morrisjs.github.io/morris.js/</a>.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- /.row -->\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-bar-chart-o\"></i> Area Line Graph Example with\n");
      out.write("\t\t\t\t\t\t\t\t\tTooltips\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-long-arrow-right\"></i> Donut Chart Example\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-long-arrow-right\"></i> Line Graph Example with\n");
      out.write("\t\t\t\t\t\t\t\t\tTooltips\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"panel-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-long-arrow-right\"></i> Bar Graph Example\n");
      out.write("\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
